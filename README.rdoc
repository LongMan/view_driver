...
Still the 'sections' is a before_filter it can be chained and controlled by standard options: :only, :except, :if, and :unless.
...
==== Other examples
  ...
  # because nil value is a signal to use default templates
